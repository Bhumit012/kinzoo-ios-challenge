...
final class SnapShotTestDetails: XCTestCase {
    var dataModel = CharacterDataManager.shared
    
    var vc: CharactersDetailsViewController!
    ...
    override func setUpWithError() throws {
        ...
        let vm = CharacterDetailViewModel(characterDataManager: dataModel)
        
        vm.currentCharID = 1

        vc = CharactersDetailsViewController(viewModel: vm)
    ...
    func testExampleDetailPage() throws {
